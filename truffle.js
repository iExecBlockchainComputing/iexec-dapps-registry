...
module.exports = {
    networks: {
        ...
        ropsten: {
            ...
            port: 8545,
            network_id: "3",
            iexecOracleAddress: "0xb34406538112bd2b3036b2c417c7cff827777a11", // oracle v0.1.2 ropsten
        ...
        rinkeby: {
            ...
            port: 8545,
            network_id: "4",
            iexecOracleAddress: "0x98275d4b6511ef05ed063d127dd82b72588326c9",// oracle v0.1.2 rinkeby
        },
        kovan: {
            host: "https://kovan.infura.io/berv5GTB5cSdOJPPnqOq",
            port: 8545,
            network_id: "42",
            iexecOracleAddress: "0xb81d38d843cb526a3d0c3130d568fe09799135aa",// oracle v0.1.2 kovan
        },
    }
};
